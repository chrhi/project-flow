...
const Page: NextPage = () => {
  ...
  return (
    <> 
    <Header />
      <main className=" w-full container min-h-[calc(100vh-50px)] p-1 pt-4 md:p-8 lg:px-24 h-fit ">
       
        <h1 className="lg:text-3xl  text-xl font-semibold text-gray-900">Hi 👋 this is the dashboard and your personal space</h1>  

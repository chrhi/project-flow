...
// Define your Organization and MemberOrg types if they are not already defined.
// type Organization = ...;
// type MemberOrg = ...;
    ...
    <>
      ...
      <main className="flex flex-col h-fit min-h-full w-full gap-y-4 p-4 bg-white">
        ...
        <div className="w-[80%] h-[50px] mx-auto max-w-2xl">
          <h1 className="text-2xl font-semibold text-center text-[#2F3349]">
            Complete your profile to join your agency workspace
          </h1>
        </div>
          ...
          <div className="w-[80%] flex items-center gap-x-4 h-[100px] mx-auto max-w-2xl">
            <div className="w-[20%] gap-y-2 flex flex-col h-full items-center">
              <Avatar className="w-24 h-24 shadow-lg">
                <AvatarImage
                  src={imagePreviewUrl || session?.user?.image || "/assets/avatar.png"}
                />
        ...
        <div className="w-[80%] flex items-center my-8 gap-x-4 h-[100px] mx-auto max-w-2xl">
          {userOrganizations.map((item) => (
            <div
              ...
              className="w-[20%] hover:border rounded-lg hover:shadow-md hover:cursor-pointer max-w-[200px] gap-y-2 flex flex-col min-h-full h-fit p-2 items-center"
            >

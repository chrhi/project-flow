...
export function ActivityListBuilder() {
  ...
  return (
    ...
    whileTap={{ scale: 1.05 }}
    className="flex w-[90%] gap-y-4    max-w-sm items-start  rounded-md border flex-col  border-gray-200 bg-white p-3 shadow-lg transition-[border-color] hover:border-black "
   >

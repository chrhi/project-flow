...
export const Header = () => {
  ...
  return (
    <div className = {`w-full !z-[50] h-12 sticky top-0 flex justify-between lg:justify-start px-4  items-center bg-white dark:bg-neutral-900 shadow-sm border-b border-gray-300 dark:border-stone-900 `}>

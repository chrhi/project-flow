...
export const Header = ({session}:Props) => {
  ...
  return (
    <>
    <div className = {`w-full !z-[50] h-[50px] sticky top-0 flex justify-between lg:justify-start px-4  items-center bg-white dark:bg-neutral-900 shadow-sm border-b border-gray-300 dark:border-stone-900 `}>

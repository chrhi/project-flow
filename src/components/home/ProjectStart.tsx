  ...
  return (
    <div className='w-full h-[120px] flex flex-col justify-center gap-y-4 my-4  p-8'>
       ...
       <p className='text-lg text-gray-600 text-start'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsa minima</p>
        ...
        <button
        className="rounded-lg w-[200px] px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm bg-indigo-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
        onClick={handleClick}
        >
            start my project
        </button>

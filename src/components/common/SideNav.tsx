...
export  const  SideNav  = () => {
  ...
  <div className="fixed flex flex-col top-0 left-0 w-[4rem] bg-white custopn-page-height mt-[55px] shadow-lg border-r border-gray-[100px]">
    ...
    <div className="overflow-y-auto overflow-x-hidden flex-grow">
      <ul className="flex flex-col py-4 space-y-1">
        ...
        <li>
          ...
          className={`!relative !w-full !flex !flex-col  !normal-case !h-[4rem]  !items-center !justify-start  !focus:outline-none !hover:bg-gray-50  !hover:bg-sky-100 !p-4

    ...
    <>
      <div className={`${isOpen ? "hidden" : ""} z-[9999] absolute top-[40%] left-[-30px] rounded-[50%] mt-[50px]`}>
        ...
        <motion.div
          ...
          exit="exit"
          className={`fixed flex flex-col m-4 ml-[75px] mt-0 top-[2rem] left-[0px] shadow-lg lg:shadow-none  z-[9] ${isOpen ? " w-full pr-4 md:pr-0  md:w-[20rem]" : " w-[0] "}  bg-white lg:bg-gray-50  dark:bg-neutral-800 custopn-page-height rounded-lg border-gray-[100px]`}
        >
